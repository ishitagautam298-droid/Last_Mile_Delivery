...
const CreateOrderPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    pickupStreet: 'E-4, Arera Colony Main Road',
    pickupPincode: prefillData.pickupPincode || '462016',
    pickupArea: prefillData.pickupArea || 'Arera Colony (E1-E7)',
    pickupCity: prefillData.pickupCity || 'Bhopal',
    dropStreet: 'C-Sector, Sarvdharm Colony',
    dropPincode: prefillData.dropPincode || '462042',
    dropArea: prefillData.dropArea || 'Kolar Road & Sarvdharm',
    dropCity: prefillData.dropCity || 'Bhopal',
